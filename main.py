...
cred = credentials.Certificate('nurshat.json')
firebase_admin.initialize_app(cred, {
    "databaseURL": "https://telebot-79c49-default-rtdb.firebaseio.com/"
})
ref = db.reference()

bot = telebot.TeleBot('1757824560:AAEbsI-1P3MIFpojTahFYSQOMEAVTkjH1iU')
...
def handle_start(message):
    ...
    sent = bot.send_message(message.chat.id, 'Вы можате записаться онлайн. \n'
...
def inlin(c):
    ...
    if cStr =='None':
        ...
        bot.send_message(c.message.chat.id, 'Спасибо. Вас звписали')
    else:
